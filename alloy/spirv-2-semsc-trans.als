...
sig Exec {
  ...
  ithbsemsc0_b, ithbsemsc1_b, ithbsemsc2_b, ithbsemsc3_b : E->E,
  ithbsemsc01_b, ithbsemsc02_b, ithbsemsc03_b, ithbsemsc12_b, ithbsemsc13_b, ithbsemsc23_b : E->E,
  ithbsemsc012_b, ithbsemsc013_b, ithbsemsc023_b, ithbsemsc123_b : E->E,
  ...
  ithbsemsc012, ithbsemsc013, ithbsemsc023, ithbsemsc123 : E->E,
  ithbsemsc0123 : E->E,
  ...
  ithbsemsc0_b = ^(ssw +
                 ...
                 (stor[F&SEMSC0]).po.(stor[F&SEMSC0]) +
                 (stor[SC0]).po.(stor[REL&SEMSC0]) +
                 (stor[ACQ&SEMSC0]).po.(stor[SC0]))

  ithbsemsc1_b = ^(ssw +
                 (stor[SEMSC1]).sw.(stor[SEMSC1]) +
                 (stor[F&SEMSC1]).po.(stor[F&SEMSC1]) +
                 (stor[SC1]).po.(stor[REL&SEMSC1]) +
                 (stor[ACQ&SEMSC1]).po.(stor[SC1]))

  ithbsemsc2_b = ^(ssw +
                 (stor[SEMSC2]).sw.(stor[SEMSC2]) +
                 (stor[F&SEMSC2]).po.(stor[F&SEMSC2]) +
                 (stor[SC2]).po.(stor[REL&SEMSC2]) +
                 (stor[ACQ&SEMSC2]).po.(stor[SC2]))

  ithbsemsc3_b = ^(ssw +
                 (stor[SEMSC3]).sw.(stor[SEMSC3]) +
                 (stor[F&SEMSC3]).po.(stor[F&SEMSC3]) +
                 (stor[SC3]).po.(stor[REL&SEMSC3]) +
                 (stor[ACQ&SEMSC3]).po.(stor[SC3]))

  ithbsemsc01_b = ^(ssw +
                  (stor[SEMSC01]).sw.(stor[SEMSC01]) +
                  (stor[F&SEMSC01]).po.(stor[F&SEMSC01]) +
                  (stor[SC0+SC1]).po.(stor[REL&SEMSC01]) +
                  (stor[ACQ&SEMSC01]).po.(stor[SC0+SC1]))

  ithbsemsc02_b = ^(ssw +
                  (stor[SEMSC02]).sw.(stor[SEMSC02]) +
                  (stor[F&SEMSC02]).po.(stor[F&SEMSC02]) +
                  (stor[SC0+SC2]).po.(stor[REL&SEMSC02]) +
                  (stor[ACQ&SEMSC02]).po.(stor[SC0+SC2]))

  ithbsemsc03_b = ^(ssw +
                  (stor[SEMSC03]).sw.(stor[SEMSC03]) +
                  (stor[F&SEMSC03]).po.(stor[F&SEMSC03]) +
                  (stor[SC0+SC3]).po.(stor[REL&SEMSC03]) +
                  (stor[ACQ&SEMSC03]).po.(stor[SC0+SC3]))

  ithbsemsc12_b = ^(ssw +
                  (stor[SEMSC12]).sw.(stor[SEMSC12]) +
                  (stor[F&SEMSC12]).po.(stor[F&SEMSC12]) +
                  (stor[SC1+SC2]).po.(stor[REL&SEMSC12]) +
                  (stor[ACQ&SEMSC12]).po.(stor[SC1+SC2]))

  ithbsemsc13_b = ^(ssw +
                  (stor[SEMSC13]).sw.(stor[SEMSC13]) +
                  (stor[F&SEMSC13]).po.(stor[F&SEMSC13]) +
                  (stor[SC1+SC3]).po.(stor[REL&SEMSC13]) +
                  (stor[ACQ&SEMSC13]).po.(stor[SC1+SC3]))

  ithbsemsc23_b = ^(ssw +
                  (stor[SEMSC23]).sw.(stor[SEMSC23]) +
                  (stor[F&SEMSC23]).po.(stor[F&SEMSC23]) +
                  (stor[SC2+SC3]).po.(stor[REL&SEMSC23]) +
                  (stor[ACQ&SEMSC23]).po.(stor[SC2+SC3]))

  ithbsemsc012_b = ^(ssw +
                  (stor[SEMSC012]).sw.(stor[SEMSC012]) +
                  (stor[F&SEMSC012]).po.(stor[F&SEMSC012]) +
                  (stor[SC0+SC1+SC2]).po.(stor[REL&SEMSC012]) +
                  (stor[ACQ&SEMSC012]).po.(stor[SC0+SC1+SC2]))

  ithbsemsc013_b = ^(ssw +
                  (stor[SEMSC013]).sw.(stor[SEMSC013]) +
                  (stor[F&SEMSC013]).po.(stor[F&SEMSC013]) +
                  (stor[SC0+SC1+SC3]).po.(stor[REL&SEMSC013]) +
                  (stor[ACQ&SEMSC013]).po.(stor[SC0+SC1+SC3]))

  ithbsemsc023_b = ^(ssw +
                  (stor[SEMSC023]).sw.(stor[SEMSC023]) +
                  (stor[F&SEMSC023]).po.(stor[F&SEMSC023]) +
                  (stor[SC0+SC2+SC3]).po.(stor[REL&SEMSC023]) +
                  (stor[ACQ&SEMSC023]).po.(stor[SC0+SC2+SC3]))

  ithbsemsc123_b = ^(ssw +
                  (stor[SEMSC123]).sw.(stor[SEMSC123]) +
                  (stor[F&SEMSC123]).po.(stor[F&SEMSC123]) +
                  (stor[SC1+SC2+SC3]).po.(stor[REL&SEMSC123]) +
                  (stor[ACQ&SEMSC123]).po.(stor[SC1+SC2+SC3]))

  ithbsemsc0123 = ^(ssw +
                  (stor[SEMSC0123]).sw.(stor[SEMSC0123]) +
                  (stor[F&SEMSC0123]).po.(stor[F&SEMSC0123]) +
                  (stor[SC0+SC1+SC2+SC3]).po.(stor[REL&SEMSC0123]) +
                  (stor[ACQ&SEMSC0123]).po.(stor[SC0+SC1+SC2+SC3]))

  ithbsemsc012 = ithbsemsc012_b . (rc[ *(ithbsemsc012_b + ithbsemsc0123) . ithbsemsc012_b ])
  ithbsemsc013 = ithbsemsc013_b . (rc[ *(ithbsemsc013_b + ithbsemsc0123) . ithbsemsc013_b ])
  ithbsemsc023 = ithbsemsc023_b . (rc[ *(ithbsemsc023_b + ithbsemsc0123) . ithbsemsc023_b ])
  ithbsemsc123 = ithbsemsc123_b . (rc[ *(ithbsemsc123_b + ithbsemsc0123) . ithbsemsc123_b ])

  ithbsemsc01 = ithbsemsc01_b . (rc[ *(ithbsemsc01_b + ithbsemsc012 + ithbsemsc013) . ithbsemsc01_b ])
  ithbsemsc02 = ithbsemsc02_b . (rc[ *(ithbsemsc02_b + ithbsemsc012 + ithbsemsc023) . ithbsemsc02_b ])
  ithbsemsc03 = ithbsemsc03_b . (rc[ *(ithbsemsc03_b + ithbsemsc013 + ithbsemsc023) . ithbsemsc03_b ])
  ithbsemsc12 = ithbsemsc12_b . (rc[ *(ithbsemsc12_b + ithbsemsc012 + ithbsemsc123) . ithbsemsc12_b ])
  ithbsemsc13 = ithbsemsc13_b . (rc[ *(ithbsemsc13_b + ithbsemsc013 + ithbsemsc123) . ithbsemsc13_b ])
  ithbsemsc23 = ithbsemsc23_b . (rc[ *(ithbsemsc23_b + ithbsemsc023 + ithbsemsc123) . ithbsemsc23_b ])

  ithbsemsc0 = ithbsemsc0_b . (rc[ *(ithbsemsc0_b + ithbsemsc01 + ithbsemsc02 + ithbsemsc03) . ithbsemsc0_b ])
  ithbsemsc1 = ithbsemsc1_b . (rc[ *(ithbsemsc1_b + ithbsemsc01 + ithbsemsc12 + ithbsemsc13) . ithbsemsc1_b ])
  ithbsemsc2 = ithbsemsc2_b . (rc[ *(ithbsemsc2_b + ithbsemsc02 + ithbsemsc12 + ithbsemsc23) . ithbsemsc2_b ])
  ithbsemsc3 = ithbsemsc3_b . (rc[ *(ithbsemsc3_b + ithbsemsc03 + ithbsemsc13 + ithbsemsc23) . ithbsemsc3_b ])
